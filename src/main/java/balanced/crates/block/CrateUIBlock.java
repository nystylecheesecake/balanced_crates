...
public class CrateUIBlock extends BalancedCratesModElements.ModElement {
	@ObjectHolder("balanced_crates:crate_ui")
	public static final Block block = null;

	public CrateUIBlock(BalancedCratesModElements instance) {
		super(instance, 20);
	}
