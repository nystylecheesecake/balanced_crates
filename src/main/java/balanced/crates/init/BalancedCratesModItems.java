...
public class BalancedCratesModItems {
	...
	public static final RegistryObject<Item> LARGE_INDUSTRIAL_CRATE = block(BalancedCratesModBlocks.LARGE_INDUSTRIAL_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_OAK_CRATE = block(BalancedCratesModBlocks.LARGE_OAK_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_SPRUCE_CRATE = block(BalancedCratesModBlocks.LARGE_SPRUCE_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_BIRCH_CRATE = block(BalancedCratesModBlocks.LARGE_BIRCH_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_JUNGLE_CRATE = block(BalancedCratesModBlocks.LARGE_JUNGLE_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_ACACIA_CRATE = block(BalancedCratesModBlocks.LARGE_ACACIA_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_DARK_OAK_CRATE = block(BalancedCratesModBlocks.LARGE_DARK_OAK_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_CRIMSON_CRATE = block(BalancedCratesModBlocks.LARGE_CRIMSON_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> LARGE_WARPED_CRATE = block(BalancedCratesModBlocks.LARGE_WARPED_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	...
	public static final RegistryObject<Item> OPEN_WARPED_CRATE = block(BalancedCratesModBlocks.OPEN_WARPED_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_INDUSTRIAL_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_INDUSTRIAL_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_OAK_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_OAK_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_SPRUCE_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_SPRUCE_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_BIRCH_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_BIRCH_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_JUNGLE_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_JUNGLE_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_ACACIA_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_ACACIA_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_DARK_OAK_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_DARK_OAK_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_CRIMSON_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_CRIMSON_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
	public static final RegistryObject<Item> OPEN_LARGE_WARPED_CRATE = block(BalancedCratesModBlocks.OPEN_LARGE_WARPED_CRATE,
			BalancedCratesModTabs.TAB_BALANCED_CRATES);
