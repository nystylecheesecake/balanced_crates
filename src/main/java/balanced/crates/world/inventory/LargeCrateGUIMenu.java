...
package balanced.crates.world.inventory;
...
import balanced.crates.init.BalancedCratesModMenus;

public class LargeCrateGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LargeCrateGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BalancedCratesModMenus.LARGE_CRATE_GUI, id);
