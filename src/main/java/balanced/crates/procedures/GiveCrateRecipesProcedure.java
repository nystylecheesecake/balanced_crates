...
public class GiveCrateRecipesProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (itemstack.getItem() == Blocks.CHEST.asItem() || itemstack.is(ItemTags.create(new ResourceLocation("forge:crates")))) {
			...
			if (entity instanceof ServerPlayer _serverPlayer)
				_serverPlayer.awardRecipesByKey(new ResourceLocation[]{new ResourceLocation("balanced_crates:industrial_crate_recipe_1")});
		}
	}
}
